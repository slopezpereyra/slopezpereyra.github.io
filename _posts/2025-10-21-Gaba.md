...
<figure style="text-align:center;">
    ...
    <figcaption><em>Interneuronas GABAérgicas en microcircuitos corticales</em></figcaption>
</figure>

<figure style="text-align:center;">
    <img src="../Images/GABAAReceptor.gif" width="60%" style="border: 6px solid #231709;">
    <figcaption><em>Rotación de 360 grados del receptor humano GABA<sub>A</sub> α1β3γ2 alrededor de su eje vertical. El sitio de unión de las benzodiacepinas está resaltado en cian.</em></figcaption>
</figure>
...
encontrarse en la referencia (1).
...
depresión. La llamada *GABAergic deficit hypothesis* de la depresión sostiene
