...
certain conductance $g_{sra}$. This current is modeled as a $K^{+}$ flow an
...
Here, $r_m$ determines the strength of the influence of the hyperpolarizing
current. It may be understood to reflect several factors involved in the
strength of this current, such as the density of the $K^{+}$ channels that
induce spike-rate adaptation. 
