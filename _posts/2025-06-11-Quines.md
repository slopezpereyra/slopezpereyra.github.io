...
> Convención: Dado un estado $\sigma \in \Sigma$, usamos $[[c]]\sigma$ para
> denotar la semántica del comando $c \in \text{comm}$ en el estado $\sigma$,
> donde la semántica es una función en $\text{<comm>} \to \Sigma \to \Sigma$.
