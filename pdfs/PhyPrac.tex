...
\textbf{(4)} Sean $\vec{u}, \vec{d}$ los vectores unitarios que apuntan hacia
$(1, 1)$ y $(1, -1)$ respectivamente. La distancia entre el punto central
...
Notemos que una partícula de carga unitaria y positiva ubicada en \textbf{p}
sería atraída por las cargas negativas de la derecha y repelida por las cargas
positivas de la izquierda. Más aún, la carga inferior izquierda empujaría la
partícula equidireccionalmente a la atracción de la carga superior derecha, y lo
mismo sucede entre las cargas superior izquierda e inferior derecha (ver
diagrama).
...
Note that $q_1, \ldots, q_4$ are equal in absolute value. Let $\left| q_i
\right| = q $. Then:


\begin{align*}
    \frac{1}{2\pi \epsilon_0} \sum_{i=1}^4 \frac{q_i}{d^2} \vec{r_i}
    &= \frac{1}{2\pi \epsilon_0 d^2 } 
    \left[ q_1 \vec{d} + q_2 \vec{u} + q_3 \vec{u} + q_4 \vec{d} \right]  \\ 
    &= \frac{1}{2\pi \epsilon_0 d^2} \left[ (q_1 + q_4)\vec{d} + (q_2 +
    q_3)\vec{u} \right] \\ 
    &=\frac{1}{2\pi \epsilon_0 d^2}\left[ 2q \vec{d} + 2q \vec{u} \right] \\ 
    &=\frac{q}{\pi \epsilon_0 d^2}\left[ \vec{d} + \vec{u} \right] 
\end{align*}
