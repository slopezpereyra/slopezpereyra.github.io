...
The expression in $(9)$ is the numerator in $(7)$, whereby we obtain via
substitution: 
...
Equation $(10)$ ensures that the error scales quadratically. Now we wish to
bound the error expression in $(10)$. To bound $e_{n+1}$, we define we take
$\delta > 0$ to define a neighbourhood of length $\delta$ around $r$. For any
$x$ in this neighbourhood, $(10)$ reaches its maximum when the numerator is
