...
\begin{definition}
    ...
    \right\} $ an alphabet and $\mathcal{V}$ the following language of that
    alphabet:

    \begin{equation*}
        \mathcal{V} := \left\{ \textbf{X1}, \ldots, \textbf{X 9}, \textbf{X 1 0}, \textbf{X11},\ldots, \textbf{X 1 9}, \ldots, \textbf{2 0}, \textbf{X 2 1}, \ldots \right\} 
    \end{equation*}
\end{definition}
