...
\begin{center}
\includegraphics[scale=0.05]{Sep}
\end{center}
\begin{theorem}
...
\textbf{Proof.} Recall that $ker(f) = \left\{ (a, b) \in \mathcal{D}_f^2 : f(a)
...
\textbf{Proof.} Assume $F$ a bijective homomorphism. Observe that, since 
$F$ is a homomorphism,
