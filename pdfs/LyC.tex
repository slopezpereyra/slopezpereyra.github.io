...
\begin{titlepage}
   \begin{center}
       ...
       \Huge
       \textbf{Lenguajes y Compiladores  Resumen del teórico y prácticos
       resultos}
...
Las notas del teórico son esquemáticas e incompletas: se aconseja seguir el
libro y no este apunte. Tal vez el único tema en que sean útiles sea la sección
2.6, \textit{Abstrayendo $\Omega$}, donde se discuten los isomorfismos sobre
$\Omega$---al menos en la medida en que es el tema más abstracto del curso.

Los ejercicios resueltos pueden contener errores y deben leerse con espíritu
crítico.
