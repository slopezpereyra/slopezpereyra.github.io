...
teorema de Gödel, la mística cristiana y la computación teórica. Vi la inclemencia
de la tierra llevarse a una mujer que amaba; bebí de la copa del diablo y del cáliz
artúrico; morí mil muertes oscuras y perfectas. Sin embargo, sólo una cosa,
...
\begin{quote}
    ...
    \footnotesize
\hspace*{\fill}\textit{Nuestra alma, pozo de agua viva.}\\
...
que acecha nuestros sueños redentores
~
...
\begin{quote}
    ...
    \hspace*{\fill}and a light unto my path.\\
...
\pagebreak
\subsection{Fue un trece de junio}
~ 
...
\pagebreak 
\subsection{Romance de las casas}

\begin{verse}

casas, casas como pueblos 
de desalentados odios\ldots
...
(En la nocturna arena no hay pies que dejen huella.)
\end{verse}
...
\begin{verse}
   ...
   creo que algo familiar hay en mi gesto,
   ...
   Yo trato de sentir que son hermosas,
   pero es en vano: el tragaluz ha urdido
   su lobreguez arcana. En la veranda 
   la tarde inescrutable y gris ablanda 
