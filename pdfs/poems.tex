...
podría valer por una vida entera. En ella conocí el lejano oriente y las
distantes capitales del mundo occidental; descrubrí la prosa de Faulkner, el
teorema de Gödel, la mística cristiana y la computación teórica. Una mujer que
amaba besó la boca de la muerte; probé la copa del diablo y el cáliz artúrico, y
morí muertes oscuras y perfectas. Sin embargo, sólo una cosa, entonces como
ahora, me ha obligado a escribir: una melancolía secreta y sin esperanza que
nunca supe descubrir, que vive el oscuro cautiverio de mis páginas privadas, y
de la que ahora deseo emanciparme.
...
\pagebreak
\subsection{Eras como la aurora, penumbra y mediodía}
~ 
...
\subsection{Eras como la aurora, que es madre del rocío}
...
\subsection{Cerca del cementerio}
...
\pagebreak 
\subsection{Los corazones se buscan}

\begin{verse}
    
Los corazones se buscan.
La calle parece llena.
Lejos, la diafanidad.
La noche cerca.
Habitaciones del alma,
dejen cerrada su puerta.
Lejos el día.
La noche cerca.
\end{verse}

\pagebreak
\subsection{Parece un nido tu casa}
...
\begin{verse}
Los vendavales avanzan.
La enseñanza:
cuando seas una marea
de viento —cuando no seas—,
entonces te moverás.

Lo demás es movimiento,
no viento, que es la verdad.
\end{verse}
